...
<table id="serverList" class="easyui-datagrid" title="<?php echo ($currentpos); ?>" data-options="
	...
	url:'<?php echo U('Service/servicetype',array('id'=>I('id',0)));?>',idField:'id',border:false,
...
<!-- 添加 -->
<div id="addserBox" class="easyui-dialog" title="添加服务站点类别"
...
function deleteServer(id){
	...
	$.messager.confirm('提示信息', '确定要删除吗？', function(result){
		...
		$.post('<?php echo U('Service/deleteservicetype');?>', {id: id}, function(data){
			if(!data.status){
