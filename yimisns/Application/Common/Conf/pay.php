...
return array(
    'alipay_config'=>array(
        ...
        'key'           => 'm0rxhva3n2nbukr7qgv9cwk7l4ua4kyq',//这里是你在成功申请支付宝接口后获取到的Key
    ...
    'mobilepay_config'=>array(
        'app_id'              =>'2016040801279307', //支付宝分配给开发者的应用ID
        'partner'             => '2088221257643345',   //这里是你在成功申请支付宝接口后获取到的PID；
        ...
        'notify_url'          => 'http://www.yimisns.com/yimisns.com/index.php/user/api/notifyurl',
