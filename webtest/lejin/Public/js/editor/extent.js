/**
 * Author : ____′↘夏悸 Easyui KindEditor的简单扩展.
 * 有了这个之后,你就可以像使用Easyui组件的方式使用KindEditor了 前提是你需要导入KindEditor的核心js和相关样式.
 * 本插件也需要在Easyui.min和KindEditor之后导入.
...
(function($, K) {
	...
	$.fn.kindeditor.defaults = {
		...
		fileManagerJson : EDITOR_FILE_MANAGER,
