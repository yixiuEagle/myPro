...
<table id="addBox">
	<tr>
		<td>名称：</td>
		<td><input id="edit_category_name" name="name" value="<?php echo ($info["name"]); ?>" type="text" style="width:178px;height:22px" /></td>
		<td><div id="edit_category_nameTip"></div></td>
	</tr>
	<tr>
		<td colspan="3"><input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" /></td>
	</tr>
</table>
</form>