...
<title>后台管理系统</title>
<link rel="stylesheet" type="text/css" href="/webtest/lejin/Public/js/easyui/themes/bootstrap/easyui.css" />
<link rel="stylesheet" type="text/css" href="/webtest/lejin/Public/js/easyui/themes/icon.css" />
<script type="text/javascript" src="/webtest/lejin/Public/js/jquery.min.js"></script>
<!-- <script type="text/javascript" src="/webtest/lejin/Public/js/jquery-migrate-1.2.1.min.js"></script> -->
<script type="text/javascript" src="/webtest/lejin/Public/js/easyui/jquery.easyui.min.js"></script>
<script type="text/javascript" src="/webtest/lejin/Public/js/easyui/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="/webtest/lejin/Public/js/easyui/autoResize.js"></script>
<link rel="shortcut icon" href="/webtest/lejin/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/webtest/lejin/Public/js/formvalidator/formValidator.min.js"></script>
<script type="text/javascript" src="/webtest/lejin/Public/js/formvalidator/formValidatorRegex.js"></script>
<script type="text/javascript" src="/webtest/lejin/Public/js/uploadify/jquery.uploadify.min.js"></script>
<link type="text/css" rel="stylesheet" href="/webtest/lejin/Public/js/uploadify/uploadify.css">
...
<link rel="stylesheet" href="/webtest/lejin/Public/js/editor/themes/default/default.css" />
<script charset="utf-8" src="/webtest/lejin/Public/js/editor/kindeditor-min.js"></script>
<script charset="utf-8" src="/webtest/lejin/Public/js/editor/lang/zh_CN.js"></script>
<script charset="utf-8" src="/webtest/lejin/Public/js/editor/extent.js"></script><!-- 编辑器 -->
<link rel="stylesheet" type="text/css" href="/webtest/lejin/Public/css/admin/bootstrap.css" />
...
function onChangeTheme(theme){
	$('head').find('link:first').attr('href', '/webtest/lejin/Public/js/easyui/themes/'+theme+'/easyui.css');
	$('head').find('link:last').attr('href', '/webtest/lejin/Public/css/admin/'+theme+'.css');
}
//显示左侧栏目
